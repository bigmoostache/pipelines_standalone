                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "html_contents": {
                                "type": "string",
                                "description": sota.t('', {'': {
                                    'en': 'Cite (using <blockquote> -> content in blockquote HAS to be verbatim citations) and analyse. This will be used to verify any information or statement made. It is essential for audits, scientific reviews, and fact-checking. Aim at 50-50 split between citation and analysis.',
                                    'fr': 'Citez (en utilisant <blockquote> -> le contenu dans le blockquote DOIT être des citations textuelles, verbatim) et analysez. Cela sera utilisé pour vérifier toute information ou déclaration faite. C\'est essentiel pour les audits, les revues scientifiques et la vérification des faits. Visez une répartition 50-50 entre citation et analyse.'
                                }}),
                            }
                        },
...
def rewrite(sota : SOTA, 
    ...
    return complex_rewrite(
        ...
        information_id, 
        act_on_title=True, 
        act_on_comments=final_comment, 
        act_on_contents=True, 
